...
pub const COMMANDS: &[(Command, &str, &str)] = &[
    ...
    (Command::GenerateDefinition, "Generate Definition from Declaration", ""),
    (Command::CompleteStatement, "Complete Current Statement", "Ctrl+Shift+Enter"),
    (Command::SafeDelete, "Safe Delete…", "Alt+Delete"),
    (Command::SurroundWith, "Surround With…", "Ctrl+Alt+T"),
    (Command::MoveStatementUp, "Move Statement Up", "Ctrl+Shift+Up"),
    (Command::MoveStatementDown, "Move Statement Down", "Ctrl+Shift+Down"),
    (Command::QuickDefinition, "Quick Definition", "Ctrl+Shift+I"),
    (Command::NextProblem, "Next Problem", "F2"),
    (Command::PrevProblem, "Previous Problem", "Shift+F2"),
